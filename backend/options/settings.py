...
LOGGING = {
    ...
    'handlers': {
        'console': {
            ...
            'class': 'logging.StreamHandler',  # Обработчик, который выводит логи в консоль
        },
    },
    'root': {
        'handlers': ['console'],  # Используем консольный обработчик для корневого логгера
...
KINOPOISK_API_KEY = 'ZQQ8GMN-TN54SGK-NB3MKEC-ZKB8V06'
